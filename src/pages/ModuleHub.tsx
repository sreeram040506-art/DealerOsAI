...
const modules: Record<string, ModuleDefinition> = {
  ...
  "/rmv-compliance": {
    title: "RMV Compliance",
    purpose: "Operational compliance center to prevent penalties and missing submissions.",
    sections: ["Pending Forms", "Missing Signatures", "Expired Registration", "Title Transfer Checks"],
    aiFeatures: ["Compliance alert feed", "Deadline risk prediction", "Missing field prioritization"],
  },
  "/insurance": {
    title: "Insurance",
    purpose: "Track policy lifecycle and linkage to customer, deal, and VIN.",
    sections: ["Provider", "Policy Number", "Coverage", "Effective/Expiration", "Customer-VIN Mapping"],
    aiFeatures: ["Expiration alerts", "Auto-fill RMV fields", "Reminder automation"],
  },
  "/warranty": {
    title: "Warranty",
    purpose: "Store warranty coverage, claims, and upsell insights per deal.",
    sections: ["Warranty Company", "Coverage Type", "Expiration Miles", "Expiration Date", "Claims"],
    aiFeatures: ["Upsell propensity scoring", "Coverage gap detection", "Claim pattern summaries"],
  },
  "/marketing": {
    title: "Marketing",
    purpose: "Track multi-channel listing performance and source-level conversions.",
    sections: ["Facebook", "Craigslist", "Instagram", "TikTok", "Website", "Google Ads", "YouTube Shorts"],
    aiFeatures: ["Title/description generation", "Pricing optimization", "Hashtag and channel recommendations"],
  },
  "/ai-insights": {
    title: "AI Insights",
    purpose: "Dealer-level intelligence for inventory velocity, pricing, and profit optimization.",
    sections: ["Market Demand", "Seasonal Trends", "Fastest Sellers", "Local Pricing", "Buying Assistant"],
    aiFeatures: ["Dynamic pricing suggestions", "Auction ceiling recommendations", "Vehicle-level deal summaries"],
  },
  "/accounting": {
    title: "Accounting",
  ...
  "/auctions": {
    title: "Auctions",
    purpose: "Auction pipeline for sourcing decisions and bid strategy.",
    sections: ["Auction Source", "Lane Number", "Estimated Value", "Max Bid", "Transport Estimate"],
    aiFeatures: ["Smart bid limits", "Demand-aware acquisition advice", "Do-not-buy risk flags"],
  },
  "/mobile-scanner": {
    title: "Mobile Scanner",
    purpose: "Phone-first capture of VINs and compliance docs for instant record creation.",
    sections: ["VIN Scan", "Registration Scan", "Insurance Scan", "Driver License Scan"],
    aiFeatures: ["OCR extraction", "Auto form fill", "Customer/vehicle auto-linking"],
  },
  "/notifications": {
    title: "Notifications",
